...
#define ZERO_DETECT_A_PIN		((uint32_t)BIT0)
#define ZERO_DETECT_B_PIN		((uint32_t)BIT3)
#define ZERO_DETECT_C_PIN		((uint32_t)BIT5)
#define ZERO_DETECT_M_PIN		((uint32_t)BIT4)
