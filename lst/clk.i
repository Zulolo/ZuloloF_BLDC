#line 1 "C:\\Keil_v5\\ARM\\PACK\\Nuvoton\\NuMicro_DFP\\1.1.0\\Device\\Mini51\\Driver\\clk.c"
...
#line 12 "C:\\Keil_v5\\ARM\\PACK\\Nuvoton\\NuMicro_DFP\\1.1.0\\Device\\Mini51\\Driver\\clk.c"
...
void CLK_EnableCKO(uint32_t u32ClkSrc, uint32_t u32ClkDiv, uint32_t u32ClkDivBy1En)
{
    ...
    ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->FRQDIV = (0x1ul << (4)) | u32ClkDiv | u32ClkDivBy1En<<(5);
...
void CLK_PowerDown(void)
{
    ...
    ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->PWRCON |= ((0x1ul << (7)) | (0x1ul << (6)));
    __wfi();
}
...
void CLK_Idle(void)
{
    ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->PWRCON &= ~((0x1ul << (7)));
    __wfi();
}
