...
uint32_t SYS_GetBODStatus(void)
{
  return (((GCR_T *) (((uint32_t)0x50000000) + 0x00000))->BODCTL & (1ul << 6))?1:0;
}
...
uint32_t SYS_IsRegLocked(void)
{
  return (((GCR_T *) (((uint32_t)0x50000000) + 0x00000))->RegLockAddr & (0x1ul << 0));
}
...
void SYS_LockReg(void)
{
  ((GCR_T *) (((uint32_t)0x50000000) + 0x00000))->RegLockAddr = 0;
}
...
void SYS_UnlockReg(void)
{
  while(((GCR_T *) (((uint32_t)0x50000000) + 0x00000))->RegLockAddr != (0x1ul << 0)) {
    ((GCR_T *) (((uint32_t)0x50000000) + 0x00000))->RegLockAddr = 0x59;
    ((GCR_T *) (((uint32_t)0x50000000) + 0x00000))->RegLockAddr = 0x16;
    ((GCR_T *) (((uint32_t)0x50000000) + 0x00000))->RegLockAddr = 0x88;  
  }
}
...
void SYS_ResetModule(uint32_t u32ModuleIndex)
{
  *(volatile uint32_t *)(&(((GCR_T *) (((uint32_t)0x50000000) + 0x00000))->IPRSTC1) + (u32ModuleIndex>>24)) |= 1<<(u32ModuleIndex & 0x00ffffff);
  *(volatile uint32_t *)(&(((GCR_T *) (((uint32_t)0x50000000) + 0x00000))->IPRSTC1) + (u32ModuleIndex>>24)) &= ~(1<<(u32ModuleIndex & 0x00ffffff));
}
...
void SYS_EnableBOD(int32_t i32Mode, uint32_t u32BODLevel)
{   
    ((GCR_T *) (((uint32_t)0x50000000) + 0x00000))->BODCTL |= (1ul << 0);
    ((GCR_T *) (((uint32_t)0x50000000) + 0x00000))->BODCTL = (((GCR_T *) (((uint32_t)0x50000000) + 0x00000))->BODCTL & ~(1ul << 3)) | i32Mode; 
    ((GCR_T *) (((uint32_t)0x50000000) + 0x00000))->BODCTL = (((GCR_T *) (((uint32_t)0x50000000) + 0x00000))->BODCTL & ~(3ul << 1)) | u32BODLevel;  
}
...
{ 
  ((GCR_T *) (((uint32_t)0x50000000) + 0x00000))->BODCTL &= ~(1ul << 0);
  ((GCR_T *) (((uint32_t)0x50000000) + 0x00000))->BODCTL = (((GCR_T *) (((uint32_t)0x50000000) + 0x00000))->BODCTL & ~(3ul << 1)) | (3UL<<1) ; 
}
