#line 1 "D:\\Keil_v5\\ARM\\PACK\\Nuvoton\\NuMicro_DFP\\1.1.0\\Device\\Mini51\\Driver\\timer.c"
...
#line 12 "D:\\Keil_v5\\ARM\\PACK\\Nuvoton\\NuMicro_DFP\\1.1.0\\Device\\Mini51\\Driver\\timer.c"
...
void TIMER_Delay(TIMER_T *timer, uint32_t u32Usec)
{
    ...
    timer->TCSR = (0x1ul << (30)) | u32Prescale; 
...
void TIMER_EnableCapture(TIMER_T *timer, uint32_t u32CapMode, uint32_t u32Edge)
{
    ...
    timer->TEXCON = (timer->TEXCON & ~((0x1ul << (8)) |
                                       (0x1ul << (4)) |
                                       (0x3ul << (1)))) |
...
void TIMER_EnableEventCounter(TIMER_T *timer, uint32_t u32Edge)
{
    timer->TEXCON = (timer->TEXCON & ~(0x1ul << (0))) | u32Edge;
    timer->TCSR |= (0x1ul << (24));
}
...
uint32_t TIMER_GetModuleClock(TIMER_T *timer)
{
    ...
    if(u32Src == 0)
        return((((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->PWRCON & (0x3ul << (0))) == 1 ? (12000000UL) : (32768UL));
    else if(u32Src == 1)
        return (10000UL);
    else if(u32Src == 2)
