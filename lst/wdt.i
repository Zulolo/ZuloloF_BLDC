#line 1 "C:\\Keil_v5\\ARM\\PACK\\Nuvoton\\NuMicro_DFP\\1.1.0\\Device\\Mini51\\Driver\\wdt.c"
...
#line 12 "C:\\Keil_v5\\ARM\\PACK\\Nuvoton\\NuMicro_DFP\\1.1.0\\Device\\Mini51\\Driver\\wdt.c"
               ...
               uint32_t u32EnableWakeup)
{
    ...
    ((WDT_T *) (((uint32_t)0x40000000) + 0x04000))->WTCR = u32TimeoutInterval | (0x1ul << (7)) |
                (u32EnableReset << (1)) |
                (u32EnableWakeup << (4));
    return;
}
...
void WDT_EnableInt(void)
{
    ((WDT_T *) (((uint32_t)0x40000000) + 0x04000))->WTCR = (((WDT_T *) (((uint32_t)0x40000000) + 0x04000))->WTCR & ~((0x1ul << (3)) | (0x1ul << (5)) | (0x1ul << (2)))) | (0x1ul << (6));
    return;
}
...
void WDT_DisableInt(void)
{
    ((WDT_T *) (((uint32_t)0x40000000) + 0x04000))->WTCR &= ~((0x1ul << (3)) | (0x1ul << (5)) | (0x1ul << (2)) | (0x1ul << (6)));
    return;
}
