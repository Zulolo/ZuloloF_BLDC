                  ...
                  uint32_t u32EnableWakeup)
{
    ...
    ((WDT_T *) (((uint32_t)0x40000000) + 0x04000))->WTCR = u32TimeoutInterval | (1ul << 7) |
                (u32EnableReset << 1) |
                (u32EnableWakeup << 4);
    return;
}
...
void WDT_Close(void)
{
    ((WDT_T *) (((uint32_t)0x40000000) + 0x04000))->WTCR = 0;
    return;
}
...
void WDT_EnableInt(void)
{
    ((WDT_T *) (((uint32_t)0x40000000) + 0x04000))->WTCR = (((WDT_T *) (((uint32_t)0x40000000) + 0x04000))->WTCR & ~((1ul << 3) | (1ul << 5) | (1ul << 2))) | (1ul << 6);
    return;
}
...
void WDT_DisableInt(void)
{
    ((WDT_T *) (((uint32_t)0x40000000) + 0x04000))->WTCR &= ~((1ul << 3) | (1ul << 5) | (1ul << 2) | (1ul << 6));
    return;
}
