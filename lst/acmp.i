#line 1 "D:\\Keil_v5\\ARM\\PACK\\Nuvoton\\NuMicro_DFP\\1.1.0\\Device\\Mini51\\Driver\\acmp.c"
...
#line 13 "D:\\Keil_v5\\ARM\\PACK\\Nuvoton\\NuMicro_DFP\\1.1.0\\Device\\Mini51\\Driver\\acmp.c"
...
{
    if(u32NegSrc != (0xFFUL))
        ((ACMP_T *) (((uint32_t)0x40000000) + 0xD0000))->CMPRVCR = u32NegSrc;
    ((ACMP_T *) (((uint32_t)0x40000000) + 0xD0000))->CMPCR[u32ChNum] = (((ACMP_T *) (((uint32_t)0x40000000) + 0xD0000))->CMPCR[u32ChNum] & (~((0x1ul << (4)) | (0x1ul << (2))))) |
...
void ACMP_Close(ACMP_T *acmp, uint32_t u32ChNum)
{
    ((ACMP_T *) (((uint32_t)0x40000000) + 0xD0000))->CMPCR[u32ChNum] &= (~(0x1ul << (0)));
}
