#line 1 "D:\\Keil_v5\\ARM\\PACK\\Nuvoton\\NuMicro_DFP\\1.1.0\\Device\\Mini51\\Driver\\spi.c"
...
#line 12 "D:\\Keil_v5\\ARM\\PACK\\Nuvoton\\NuMicro_DFP\\1.1.0\\Device\\Mini51\\Driver\\spi.c"
...
void SPI_Close(SPI_T *spi)
{
    ...
    ((GCR_T *) (((uint32_t)0x50000000) + 0x00000))->IPRSTC2 |= (0x1ul << (12));
    ((GCR_T *) (((uint32_t)0x50000000) + 0x00000))->IPRSTC2 &= ~(0x1ul << (12));
}
...
void SPI_EnableAutoSS(SPI_T *spi, uint32_t u32SSPinMask, uint32_t u32ActiveLevel)
{
    spi->SSR = (spi->SSR & ~((0x1ul << (2)) | (0x1ul << (0)))) | (u32SSPinMask | u32ActiveLevel) | (0x1ul << (3));
}
...
uint32_t SPI_SetBusClock(SPI_T *spi, uint32_t u32BusClock)
{
    ...
    spi->DIVIDER = (spi->DIVIDER & ~(0xfful << (0))) | u32Div;
...
void SPI_EnableFIFO(SPI_T *spi, uint32_t u32TxThreshold, uint32_t u32RxThreshold)
{
    spi->FIFO_CTL = (spi->FIFO_CTL & ~((0x3ul << (28)) | (0x3ul << (24))) |
                     (u32TxThreshold << (28)) |
                     (u32RxThreshold << (24)));
...
void SPI_EnableInt(SPI_T *spi, uint32_t u32Mask)
{
    ...
    if((u32Mask & (0x08)) == (0x08))
        spi->FIFO_CTL |= (0x1ul << (3));

    if((u32Mask & (0x10)) == (0x10))
        spi->FIFO_CTL |= (0x1ul << (2));

    if((u32Mask & (0x20)) == (0x20))
        spi->FIFO_CTL |= (0x1ul << (6));

    if((u32Mask & (0x40)) == (0x40))
        spi->FIFO_CTL |= (0x1ul << (21));
}
