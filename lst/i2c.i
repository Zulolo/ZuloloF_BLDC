...
uint32_t I2C_GetClockBusFreq(I2C_T *i2c)
{
    uint32_t u32Divider = ((I2C_T *) (((uint32_t)0x40000000) + 0x20000))->I2CLK;
...
void I2C_SetSlaveMask(I2C_T *i2c, uint8_t u8SlaveNo, uint8_t u8SlaveAddrMask)
{
    ...
    {
        case 0:
            i2c->I2CADM0  = u8SlaveAddrMask;
            break;
        case 1:
            i2c->I2CADM1  = u8SlaveAddrMask;
            break;
        case 2:
            i2c->I2CADM2  = u8SlaveAddrMask;
            break;
        case 3:
            i2c->I2CADM3  = u8SlaveAddrMask;
            break;
        default:
            i2c->I2CADM0  = u8SlaveAddrMask;
    }
