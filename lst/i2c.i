#line 1 "C:\\Keil_v5\\ARM\\PACK\\Nuvoton\\NuMicro_DFP\\1.1.0\\Device\\Mini51\\Driver\\i2c.c"
...
#line 12 "C:\\Keil_v5\\ARM\\PACK\\Nuvoton\\NuMicro_DFP\\1.1.0\\Device\\Mini51\\Driver\\i2c.c"
...
void I2C_Close(I2C_T *i2c)
{
    ...
    ((GCR_T *) (((uint32_t)0x50000000) + 0x00000))->IPRSTC2 |= (0x1ul << (8));
    ((GCR_T *) (((uint32_t)0x50000000) + 0x00000))->IPRSTC2 &= ~(0x1ul << (8));
...
uint32_t I2C_GetIntFlag(I2C_T *i2c)
{
    return ( (i2c->I2CON & (0x1ul << (3))) == (0x1ul << (3)) ? 1:0 );
}
