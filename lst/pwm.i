#line 1 "D:\\Keil_v5\\ARM\\PACK\\Nuvoton\\NuMicro_DFP\\1.1.0\\Device\\Mini51\\Driver\\pwm.c"
...
#line 12 "D:\\Keil_v5\\ARM\\PACK\\Nuvoton\\NuMicro_DFP\\1.1.0\\Device\\Mini51\\Driver\\pwm.c"
                                  ...
                                  uint32_t u32DutyCycle)
{
    ...
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->CSR = (((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->CSR & ~((0x7ul << (0)) << (4 * u32ChannelNum))) | (u8Divider << (4 * u32ChannelNum));
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->PCR = (((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->PCR & ~(0x1ul << (31))) | ((0x1ul << (3)) << (4 * u32ChannelNum));
    if(u32DutyCycle == 0)
...
{
    if(u32ChannelNum < 4) {
        ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->TRGCON0 = (((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->TRGCON0 & ~(((0x1ul << (3)) |
                                          (0x1ul << (2)) |
                                          (0x1ul << (1)) |
                                          (0x1ul << (0)) ) << (8 * u32ChannelNum))) | (u32Condition << (8 * u32ChannelNum));
    } else {
        ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->TRGCON1 = (((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->TRGCON1 & ~(((0x1ul << (3)) |
                                          (0x1ul << (2)) |
                                          (0x1ul << (1)) |
...
void PWM_ClearFaultBrakeFlag (PWM_T *pwm, uint32_t u32BrakeSource)
{
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->PFBCON = (0x1ul << (7));
}
...
void PWM_EnableDeadZone (PWM_T *pwm, uint32_t u32ChannelNum, uint32_t u32Duration)
{
    ...
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->PCR |= ((0x1ul << (24)) << u32ChannelNum);
}
...
void PWM_EnableDutyInt (PWM_T *pwm, uint32_t u32ChannelNum, uint32_t u32IntDutyType)
{
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->PIER |= ((0x1ul << (8)) << u32ChannelNum);
}
...
void PWM_ClearDutyIntFlag (PWM_T *pwm, uint32_t u32ChannelNum)
{
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->PIIR = ((0x1ul << (8)) << u32ChannelNum);
}
...
uint32_t PWM_GetDutyIntFlag (PWM_T *pwm, uint32_t u32ChannelNum)
{
    return(((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->PIIR & ((0x1ul << (8)) << u32ChannelNum) ? 1 : 0);
}
...
void PWM_EnableFaultBrakeInt (PWM_T *pwm, uint32_t u32BrakeSource)
{
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->PIER |= (0x1ul << (16));
}
...
void PWM_EnablePeriodInt (PWM_T *pwm, uint32_t u32ChannelNum,  uint32_t u32IntPeriodType)
{
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->PIER = (((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->PIER & ~(0x1ul << (17))) | ((0x1ul << (0)) << u32ChannelNum) | u32IntPeriodType;
}
...
void PWM_DisablePeriodInt (PWM_T *pwm, uint32_t u32ChannelNum)
{
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->PIER &= ~((0x1ul << (0)) << u32ChannelNum);
}
...
void PWM_ClearPeriodIntFlag (PWM_T *pwm, uint32_t u32ChannelNum)
{
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->PIIR = ((0x1ul << (0)) << u32ChannelNum);
}
...
uint32_t PWM_GetPeriodIntFlag (PWM_T *pwm, uint32_t u32ChannelNum)
{
    return(((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->PIIR & ((0x1ul << (0)) << u32ChannelNum) ? 1 : 0);
}
