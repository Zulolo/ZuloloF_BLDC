...
uint32_t PWM_ConfigOutputChannel (PWM_T *pwm, 
                                  ...
                                  uint32_t u32DutyCycle)
{
    uint32_t i = SystemCoreClock / u32Frequncy;
    uint8_t  u8Divider = 1, u8Prescale = 0xFF;
    uint16_t u16CNR = 0xFFFF;
    
    for(; u8Divider < 17; u8Divider <<= 1) {  
        i = (SystemCoreClock / u32Frequncy) / u8Divider;
    ...
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->PCR |= (1ul << 3) << (4 * u32ChannelNum);
...
void PWM_EnableFaultBreak (PWM_T *pwm, 
                           ...
                           uint32_t u32BreakSource)
{
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->PFBCON = (u32LevelMask << 24) | u32BreakSource;
}
...
void PWM_ClearFaultBreakIntFlag (PWM_T *pwm, uint32_t u32BreakSource)
{
    ((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->PIIR = u32BreakSource;
}
...
uint32_t PWM_GetFaultBreakIntFlag (PWM_T *pwm, uint32_t u32BreakSource)
{
    return (((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->PIIR & u32BreakSource ? 1 : 0);
}
