...
void TMR1_IRQHandler(void)                                   
{
	...
	if (ENUM_TIM1_AVOID_ZXD == FLAG_TIM1_USEAGE)
	{
		...
		((ACMP_T *) (((uint32_t)0x40000000) + 0xD0000))->CMPSR |= (0x1ul << (0));
		(((ACMP_T *) (((uint32_t)0x40000000) + 0xD0000))->CMPCR[0] |= (0x1ul << (1)));
	}
	else
	{	
		if ((((((PWM_T *) (((uint32_t)0x40000000) + 0x40000))->PHCHG & (1ul << 7)) >> 7) == (( ((ACMP_T *) (((uint32_t)0x40000000) + 0xD0000))->CMPSR & (0x1ul << (2))) >> (2))))
		{	
...
void ADC_IRQHandler(void)
{
  ...
  iADC_ComparatorFlag = (((ADC_T *) (((uint32_t)0x40000000) + 0xE0000))->ADSR & (((0x1ul << (1))) | ((0x1ul << (2))) | ((0x1ul << (0)))));
  if(iADC_ComparatorFlag & ((0x1ul << (0))))
	{
    ...
    if(iADC_ComparatorFlag & ((0x1ul << (1))))
	{
    ...
    if(iADC_ComparatorFlag & ((0x1ul << (2))))
	{
    ...
    (((ADC_T *) (((uint32_t)0x40000000) + 0xE0000))->ADSR = (((ADC_T *) (((uint32_t)0x40000000) + 0xE0000))->ADSR & ~((0x1ul << (0)) | (0x1ul << (1)) | (0x1ul << (2)))) | (iADC_ComparatorFlag));
}
...
void SPI_IRQHandler(void)
{
	...
	( (((SPI_T *) (((uint32_t)0x40000000) + 0x30000)))->STATUS = (0x1ul << (16)) );
	if ((((SPI_T *) (((uint32_t)0x40000000) + 0x30000))->SSR & (0x1ul << (5))) == (0x1ul << (5)))
	{
