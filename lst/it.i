...
uint8_t PhaseZXDedHandler(uint32_t iThisZXDetectedTime)
{
...
void ADC_IRQHandler(void)
{
    ...
    if(iADC_ComparatorFlag & ((1ul << 0)))
	{
		...
		if (((ADC_T *) (((uint32_t)0x40000000) + 0xE0000))->ADCHER & 0x01)
		{
		...
		else if (((ADC_T *) (((uint32_t)0x40000000) + 0xE0000))->ADCHER & 0x80)
		{
			mMotor.structMotor.BATTERY = (uint16_t)((((ADC_T *) (((uint32_t)0x40000000) + 0xE0000))->ADDR & (0x3FFul << 0)));
			(((ADC_T *) (((uint32_t)0x40000000) + 0xE0000))->ADCHER = (((ADC_T *) (((uint32_t)0x40000000) + 0xE0000))->ADCHER & ~(0xFFul << 0)) | (0x01));
		}
