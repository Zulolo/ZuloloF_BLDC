#line 1 "D:\\Keil_v5\\ARM\\PACK\\Nuvoton\\NuMicro_DFP\\1.1.0\\Device\\Mini51\\Driver\\adc.c"
...
#line 12 "D:\\Keil_v5\\ARM\\PACK\\Nuvoton\\NuMicro_DFP\\1.1.0\\Device\\Mini51\\Driver\\adc.c"
...
void ADC_Close(ADC_T *adc)
{
    ((GCR_T *) (((uint32_t)0x50000000) + 0x00000))->IPRSTC2 |= (0x1ul << (28));
    ((GCR_T *) (((uint32_t)0x50000000) + 0x00000))->IPRSTC2 &= ~(0x1ul << (28));
    return;
...
void ADC_EnableHWTrigger(ADC_T *adc,
                         ...
                         uint32_t u32Param)
{
    ((ADC_T *) (((uint32_t)0x40000000) + 0xE0000))->ADCR &= ~(((0x3ul << (4))) | ((0x1ul << (6))) | (0x1ul << (8)));
    if(u32Source == (0UL)) {
        ((ADC_T *) (((uint32_t)0x40000000) + 0xE0000))->ADCR |= u32Source | u32Param | (0x1ul << (8));
    } else {
        ((ADC_T *) (((uint32_t)0x40000000) + 0xE0000))->ADTDCR = (((ADC_T *) (((uint32_t)0x40000000) + 0xE0000))->ADTDCR & ~(0xfful << (0))) | u32Param;
        ((ADC_T *) (((uint32_t)0x40000000) + 0xE0000))->ADCR |= u32Source | (0x1ul << (8));
    }
    return;
}
...
{
    if(u32Mask & ((0x1ul << (0))))
        ((ADC_T *) (((uint32_t)0x40000000) + 0xE0000))->ADCR |= (0x1ul << (1));
    if(u32Mask & ((0x1ul << (1))))
        ((ADC_T *) (((uint32_t)0x40000000) + 0xE0000))->ADCMPR[0] |= (0x1ul << (1));
    if(u32Mask & ((0x1ul << (2))))
        ((ADC_T *) (((uint32_t)0x40000000) + 0xE0000))->ADCMPR[1] |= (0x1ul << (1));
