              ...
              uint32_t u32ChMask)
{
    ...
    ((ADC_T *) (((uint32_t)0x40000000) + 0xE0000))->ADCR = 0;  
...
void ADC_EnableHWTrigger(ADC_T *adc,
                         ...
                         uint32_t u32Param)
{
    ((ADC_T *) (((uint32_t)0x40000000) + 0xE0000))->ADCR &= ~(((3ul << 4)) | ((1ul << 6)) | (1ul << 8));
    if(u32Source == (0UL)) {
...
void ADC_SetExtraSampleTime(ADC_T *adc,
                            ...
                            uint32_t u32SampleTime)
{
    ((ADC_T *) (((uint32_t)0x40000000) + 0xE0000))->ADSAMP = (((ADC_T *) (((uint32_t)0x40000000) + 0xE0000))->ADSAMP & ~(0xFul << 0)) | u32SampleTime;
}
