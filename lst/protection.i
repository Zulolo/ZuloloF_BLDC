...
uint32_t* unMosfetTestTable[] = {(*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x20*(2))) + ((2)<<2)))), (*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x20*(2))) + ((4)<<2)))), (*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x20*(2))) + ((6)<<2)))),
...
void PTC_checkMotor(void)
{
    ...
    (((ADC_T *) (((uint32_t)0x40000000) + 0xE0000))->ADCMPR[0] = ((0) << (3)) | (((0x1ul << (2)))) | ((5) << (16)) | (((12) - 1) << (8)) | (0x1ul << (0)));
    
    (((ADC_T *) (((uint32_t)0x40000000) + 0xE0000))->ADCMPR[1] = ((7) << (3)) | ((0UL)) | ((393) << (16)) | ((16 - 1) << (8)) | (0x1ul << (0)));
