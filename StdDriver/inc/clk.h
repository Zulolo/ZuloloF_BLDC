...
/*---------------------------------------------------------------------------------------------------------*/
#define CLK_CLKSEL0_HCLK_S_XTAL          0x00UL /*!< Setting clock source as external X'tal */ 
...
#define CLK_CLKSEL0_STCLK_S_XTAL         0x00UL /*!< Setting clock source as external X'tal */ 
#define CLK_CLKSEL0_STCLK_S_XTAL_DIV2    0x10UL /*!< Setting clock source as external X'tal/2 */
...
/*---------------------------------------------------------------------------------------------------------*/
#define CLK_CLKSEL1_WDT_S_XTAL          0x00000000UL /*!< Setting WDT clock source as external X'tal */ 
...
#define CLK_CLKSEL1_ADC_S_XTAL          0x00000000UL /*!< Setting ADC clock source as external X'tal */
...
#define CLK_CLKSEL1_SPI_S_HXTorLXT      0x00000000UL /*!< Setting ADC clock source as HXT or LXT */
#define CLK_CLKSEL1_SPI_S_HCLK          0x00000001UL /*!< Setting ADC clock source as HCLK */
#define CLK_CLKSEL1_TMR0_S_XTAL         0x00000000UL /*!< Setting Timer 0 clock source as external X'tal */
...
#define CLK_CLKSEL1_TMR1_S_XTAL         0x00000000UL /*!< Setting Timer 1 clock source as external X'tal */
...
#define CLK_CLKSEL1_UART_S_XTAL         0x00000000UL /*!< Setting UART clock source as external X'tal */
...
/*---------------------------------------------------------------------------------------------------------*/
#define CLK_CLKSEL2_FRQDIV_XTAL        0x00000000UL /*!< Setting FRQDIV clock source as external X'tal */ 
...
/*---------------------------------------------------------------------------------------------------------*/ 
#define MODULE_APBCLK(x)                   (((x) >>31) & 0x1)    /*!< Calculate APBCLK offest on MODULE index */ 
#define MODULE_CLKSEL(x)                   (((x) >>29) & 0x3)    /*!< Calculate CLKSEL offest on MODULE index */ 
#define MODULE_CLKSEL_Msk(x)               (((x) >>25) & 0xf)    /*!< Calculate CLKSEL mask offest on MODULE index */ 
#define MODULE_CLKSEL_Pos(x)               (((x) >>20) & 0x1f)   /*!< Calculate CLKSEL position offest on MODULE index */ 
#define MODULE_CLKDIV(x)                   (((x) >>18) & 0x3)    /*!< Calculate APBCLK CLKDIV on MODULE index */ 
#define MODULE_CLKDIV_Msk(x)               (((x) >>10) & 0xff)   /*!< Calculate CLKDIV mask offest on MODULE index */ 
#define MODULE_CLKDIV_Pos(x)               (((x) >>5 ) & 0x1f)   /*!< Calculate CLKDIV position offest on MODULE index */ 
#define MODULE_IP_EN_Pos(x)                (((x) >>0 ) & 0x1f)   /*!< Calculate APBCLK offest on MODULE index */ 
...
#define ACMP_MODULE       ((0x0<<31)|(0x3<<29)|(MODULE_NoMsk<<25)|(31<<20)|(0x3<<18)|(MODULE_NoMsk<<10)|(31<<5)|CLK_APBCLK_CMP_EN_Pos)  /*!< ACMP Module */
